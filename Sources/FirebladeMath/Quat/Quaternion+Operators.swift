...
extension Quat4d {
    ...
    /// - Returns: The scaled quaternion.
    @inlinable
    public static func * (lhs: Double, rhs: Quat4d) -> Quat4d {
        FirebladeMath.multiply(lhs, rhs)
    }
    ...
    /// - Returns: The scaled quaternion.
    @inlinable
    public static func * (lhs: Quat4d, rhs: Double) -> Quat4d {
        FirebladeMath.multiply(lhs, rhs)
    }
    ...
    /// - Returns: The product of the two quaternions.
    @inlinable
    public static func * (lhs: Quat4d, rhs: Quat4d) -> Quat4d {
        FirebladeMath.multiply(lhs, rhs)
    }
    ...
    /// - Returns: The rotated vector.
    @inlinable
    public static func * (lhs: Quat4d, rhs: Vec3d) -> Vec3d {
        FirebladeMath.act(lhs, rhs)
    }
    ...
    ///   - rhs: The right-hand side quaternion.
    @inlinable
    public static func *= (lhs: inout Quat4d, rhs: Quat4d) {
        lhs = FirebladeMath.multiply(lhs, rhs)
    }
