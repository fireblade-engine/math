...
- [ ] Task: Create `ci-ios.yml` from `ci-macos.yml`
    - [ ] Extract iOS job from `ci-macos.yml`.
    - [ ] Create `.github/workflows/ci-ios.yml`.
    - [ ] Set `on:` to `workflow_dispatch:` only for `ci-ios.yml`.
